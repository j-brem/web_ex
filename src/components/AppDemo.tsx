        ...
        <div className="p-4">
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
              ...
              {percentageChange && (
                <div
                  className={clsx(
                    ...
                    percentageChange >= 0 ? 'text-ainblue-800' : 'text-gray-500',
                  )}
                >
                  {`${
                    percentageChange >= 0 ? '+' : ''
            ...
            <div className="mt-6 flex gap-4 text-xs text-gray-500">
              <div>1D</div>
              <div>5D</div>
              <div className="font-semibold text-ainblue-800">1M</div>
              <div>6M</div>
              <div>1Y</div>
              <div>5Y</div>
            </div>
            ...
            <div className="mt-4 rounded-lg bg-ainblue-800 px-4 py-2 text-center text-sm font-semibold text-white">
              Trade
            </div>
